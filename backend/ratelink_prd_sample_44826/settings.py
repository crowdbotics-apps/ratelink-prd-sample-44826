"""
Django settings for ratelink_prd_sample_44826 project.
...
ROOT_URLCONF = 'ratelink_prd_sample_44826.urls'
...
WSGI_APPLICATION = 'ratelink_prd_sample_44826.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ratelink_prd_sample_44826 API",
    "DESCRIPTION": "API documentation for ratelink_prd_sample_44826 App",
    "VERSION": "v1",
}
