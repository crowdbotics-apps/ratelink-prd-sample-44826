...
## Project Structure
    ...
    ├── ratelink_prd_sample_44826  # Django project configurations
...
1. Clone this repo and `cd ratelink_prd_sample_44826`
...
2. Clone this repo and `cd ratelink_prd_sample_44826`
